...
/***/ function(module, exports, __webpack_require__) {
	...
	var _expect = __webpack_require__(177);
	...
	var getVibilityTodos = function getVibilityTodos(todos, filter) {
	    switch (filter) {
	        case "SHOW_ALL":
	            return todos;
	        case "SHOW_ACTIVE":
	...
	var TodoList = function TodoList(_ref2) {
	    ...
	    return _react2.default.createElement(
	        ...
	        todos.map(function (t) {
	            return _react2.default.createElement(Todo, _extends({ key: t.id
	            }, t, {
	...
	var VibiliteTodoList = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(TodoList);
	...
	var setVibilite = function setVibilite(filter) {
	    return {
	...
	var mapDispatchVibiliteToProps = function mapDispatchVibiliteToProps(dispatch, ownProps) {
	    return {
	        onClick: function onClick() {
	            return dispatch(setVibilite(ownProps.filter));
	        }
	    };
	};
	var mapStateVibiliteToProps = function mapStateVibiliteToProps(state, ownProps) {
	    return {
	        active: ownProps.filter === state.visibilityFilter
	    };
	};

	var FilterLink = (0, _reactRedux.connect)(mapStateVibiliteToProps, mapDispatchVibiliteToProps)(Link);
	...
	var FootLink = function FootLink() {
	    return _react2.default.createElement(
	        'p',
	        null,
	        'SHOW: ',
	...
	var TodoApp = function TodoApp() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(VibiliteTodoList, null),
	        _react2.default.createElement(FootLink, null)
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expectation = __webpack_require__(178);

	var _Expectation2 = _interopRequireDefault(_Expectation);

	var _SpyUtils = __webpack_require__(195);

	var _assert = __webpack_require__(193);

	var _assert2 = _interopRequireDefault(_assert);

	var _extend = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEqual = __webpack_require__(179);

	var _isEqual2 = _interopRequireDefault(_isEqual);

	var _isRegex = __webpack_require__(188);
	...
	var _TestUtils = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrowFunction = __webpack_require__(182);
	var isBoolean = __webpack_require__(184);
	var isDate = __webpack_require__(185);
	var isGenerator = __webpack_require__(186);
	var isNumber = __webpack_require__(187);
	...
	var symbolIterator = __webpack_require__(191)();

	var collectionsForEach = __webpack_require__(192)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(194);
